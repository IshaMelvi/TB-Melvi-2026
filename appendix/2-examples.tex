...
Puisque la source de ces diagrammes est au format XML, les textes sont accessibles au correcteur orthographique et il vous est rendu possible les modifier sans avoir à éditer l'image. La figure ref en est un exemple.
...
Voici un autre type de diagramme utile (ref), celui d'une séquence UML.
